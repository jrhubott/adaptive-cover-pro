...
def test_config_flow_minor_version_reaches_highest_migration_target() -> None:
    ...
    Currently the highest target is 15 (the v3.14 → v3.15 no-op block that
    advances entries past the additive day_night_external_command_interlock
    option, per issue #1138).
